(function ($) {
    ...
    function createItem(lookup, item, opts) {
        ...
        return '<button type="button" class="dropdown-item autocomplete-item" data-value="' + item.value + '">' + label + '</button>';
    }
    ...
    function createItems(field, opts) {
        ...
        for (var i = 0; i < keys.length; i++) {
            ...
            if (item.label.toLowerCase().indexOf(lookup.toLowerCase()) >= 0) {
                items.find('.autocomplete-no-items').remove();
        ...
        // option action
        field.next().find('.dropdown-item.autocomplete-item').click(function () {
            field.val($(this).text());
        ...
        if (!items.children().length) {
            items.html('<li class="dropdown-item autocomplete-no-items">' + opts.noItemsLabel + '</li>');
        }
        items.addClass('dropdown-autocomplete-items').css('width', field.width() + 25);
