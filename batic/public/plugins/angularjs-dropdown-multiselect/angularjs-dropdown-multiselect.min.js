...
directiveModule.directive('ngDropdownMultiselect', ['$filter', '$document', '$compile', '$parse', function ($filter, $document, $compile, $parse) {
    return {
        ...
        template: function (element, attrs) {
            ...
            var template = '<div class="multiselect-parent _btn-group dropdown-multiselect" ng-class="{open: open}">';
            ...
            template += '<ul class="dropdown-menu dropdown-menu-form" ng-if="open" ng-style="{display: open ? \'block\' : \'none\', height : settings.scrollable ? settings.scrollableHeight : \'auto\', overflow: \'auto\' }" style="max-height:280px;transform:scale(1, 1);">';
            ...
            template += '<a ng-keydown="option.disabled || keyDownLink($event)" data-ng-class="{\'active-select\': isChecked(getPropertyForObject(option,settings.idProp))}" role="menuitem" class="option" tabindex="-1" ng-click="option.disabled || setSelectedItem(getPropertyForObject(option,settings.idProp), false, true)" ng-disabled="option.disabled">';
            ...
            if (checkboxes) {
                ...
                template += '<span data-ng-class="{\'far fa-check\': isChecked(getPropertyForObject(option,settings.idProp))}"> </span> <span mf-dropdown-static-include="{{settings.template}}"></span></a>';
            }
        ...
        link: function ($scope, $element, $attrs) {
            ...
            $scope.settings = {
                ...
                closeOnSelect: false,
                buttonClasses: 'btn btn-light w-100 text-start',
