                        ...
                        var attach = function(container, buttons) {
                            ...
                            for (i = 0, ien = buttons.length; i < ien; i++) {
                                ...
                                if ($.isArray(button)) {
                                    ...
                                    btnDisplay = '';
                                    btnClass = '';
                                    var $paginationBtn = $('<li class="paginate_button page-item"></li>'),
                                        isDisabled;

                                    switch (button) {
                                        case 'ellipsis':
                                            $paginationContainer.append('<li class="disabled"><a class="page-link" href="#" onClick="event.preventDefault()">&hellip;</a></li>');
                                            break;
        ...
        function _init(bootstrapOptions) {
            if (!_initialized) {
                ...
                _addDrawCallbackFunction(function() {
                    $('div.dataTables_filter').find('input').addClass('form-control form-control-sm');
                    $('div.dataTables_length').find('select').addClass('custom-select custom-select-sm form-control form-control-sm');
                });
