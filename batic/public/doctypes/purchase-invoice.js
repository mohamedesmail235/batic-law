baticApp.doctypes['purchase-invoice'] = {
    ...
    data: function ($rootScope) {
        let data = {
            ...
            "supplier": stringVal($rootScope.formView.form.data.supplier),
            ...
            "due_date": ($rootScope.formView.form.data.due_date) ? moment($rootScope.formView.form.data.due_date).format('YYYY-MM-DD') : "",
            "update_stock": floatVal($rootScope.formView.form.data.update_stock),
