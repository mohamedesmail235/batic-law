baticApp.doctypes['purchase-order'] = {
    ...
    data: function ($rootScope) {
        return {
            ...
            "schedule_date": moment($rootScope.formView.form.data.schedule_date).format('YYYY-MM-DD'),
    ...
    items: function (items) {
        ...
        for (let key in items) {
            if (items.hasOwnProperty(key)) {
                ...
                list_item['schedule_date'] = moment(item.schedule_date).format('YYYY-MM-DD');
